...
if (accessToken) {
    // console.log("Access Token 47:", accessToken);
...
// console.log("access_token 62", token)
if (token) {
...
console.log("before get ",jwtTokenget)
const userId = localStorage.getItem("userId");
console.log("before userId",userId) // Get the userId from local storage
